  ...
  <div class="navbar bg-red-500 hover:bg-green-500 transition-colors duration-300">
    ...
    <div class="navbar-start lg:hidden dropdown">
      <label tabindex="0" class="btn btn-ghost btn-circle avatar">
        <svg  class="text-white" xmlns="http://www.w3.org/2000/svg" width="23" height="18" viewBox="0 0 23 18" fill="none">
      ...
      @if (has_nav_menu('primary_navigation'))
        <nav class="nav-primary" aria-label="{{ wp_get_nav_menu_name('primary_navigation') }}">
          {!! wp_nav_menu(['theme_location' => 'primary_navigation', 'menu_class' => 'menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52', 'echo' => false]) !!}
        </nav>
      @endif
    </div>
    ...
    <div class="navbar-end">
      ...
      <div class="dropdown dropdown-end">
        <label tabindex="0" class="btn btn-ghost btn-circle avatar">
          <div class="indicator">
            <svg class="text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" width="21" height="22">
      ...
      <div class="dropdown dropdown-end">
        <label tabindex="0" class="btn btn-ghost btn-circle">
          <div class="indicator">
            <svg class="text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" width="18" height="22">
            ...
            <span class="badge badge-xs indicator-item bg-transparent border-transparent text-white">18</span>
          </div>
        </label>
